...
<template>
  <el-menu
    ...
    class="h-full border-r-0 !bg-[#0f172a]/80 backdrop-blur-md"
    text-color="#94a3b8"
  ...
  >
    ...
    <el-menu-item index="dashboard">
      <el-icon><div class="i-mdi-view-dashboard" /></el-icon>
    </el-menu-item>
    
    <el-menu-item index="nodes">
      <el-icon><div class="i-mdi-nodejs" /></el-icon>
    </el-menu-item>
    
    <div class="flex-1"></div> <!-- Spacer -->
    
    <el-menu-item index="settings">
      <el-icon><div class="i-mdi-cog" /></el-icon>
    </el-menu-item>
